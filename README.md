...
3. **Выберите модель**:
   - Нажмите на список моделей внизу экрана и выберите **любую доступную модель Google / Antigravity** (например, `gemini-3.6-flash-high (Antigravity) 1M`, `gemini-1.5-pro` или модели Claude).
